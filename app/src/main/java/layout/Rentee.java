...
import com.nick.finalyearproject.CustomMain;
import com.nick.finalyearproject.R;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link Rentee.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Rentee#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Rentee extends Fragment {
     ...
     * @return A new instance of fragment Rentee.
     */
    // TODO: Rename and change types and number of parameters
    public static Rentee newInstance(String param1, String param2) {
        Rentee fragment = new Rentee();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view  = inflater.inflate(R.layout.fragment_rentee, container, false);
        ...
        findButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(getContext(), CustomMain.class);
                startActivity(i);

            }
        });

        Log.d("Msg","Not Reached");
 /* two.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
      ...
      public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked==true)
                {
                    ...
                    twowheeler.setVisibility(View.INVISIBLE);
                }
      }
  });*/
        ...
        return inflater.inflate(R.layout.fragment_rentee, container, false);
    }
